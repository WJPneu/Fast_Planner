...
int main(int argc, char** argv) {
  ...
  n.param("init_state_x", _init_x, 0.0);//-19
  n.param("init_state_y", _init_y, 0.0);//0.0

  n.param("map/x_size", _x_size, 50.0);//40
  n.param("map/y_size", _y_size, 50.0);//20
  n.param("map/z_size", _z_size, 5.0);//5
  n.param("map/obs_num", _obs_num, 30);//150
  n.param("map/resolution", _resolution, 0.1);//0.1
  n.param("map/circle_num", circle_num_, 30);//30

  n.param("ObstacleShape/lower_rad", _w_l, 0.3);//0.5
  n.param("ObstacleShape/upper_rad", _w_h, 0.8);//0.7
  n.param("ObstacleShape/lower_hei", _h_l, 3.0);//0.0
  n.param("ObstacleShape/upper_hei", _h_h, 7.0);//3.0

  n.param("ObstacleShape/radius_l", radius_l_, 7.0);//0.7
  n.param("ObstacleShape/radius_h", radius_h_, 7.0);//0.5
  n.param("ObstacleShape/z_l", z_l_, 7.0);//0.7
  n.param("ObstacleShape/z_h", z_h_, 7.0);//0.8
  n.param("ObstacleShape/theta", theta_, 7.0);//0.5

  n.param("sensing/radius", _sensing_range, 10.0);//5
  n.param("sensing/rate", _sense_rate, 10.0);//10
  ...
  _obs_num = min(_obs_num, (int)_x_size * 10);//150
  _z_limit = _z_size;//5
